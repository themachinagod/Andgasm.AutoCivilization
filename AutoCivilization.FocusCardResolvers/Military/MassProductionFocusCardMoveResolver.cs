...
{
    public class MassProductionFocusCardMoveResolver : FocusCardMoveResolverBase, IMilitaryLevel3FocusCardMoveResolver
    {
        private const int BaseAttackPower = 7;
        private const int BaseAttackRange = 3;
        private const int BaseAttackCount = 2;
        private const int BaseMaxTargetPower = 8;
        ...
        public MassProductionFocusCardMoveResolver(IMilitaryResolverUtility militaryResolverUtility,
